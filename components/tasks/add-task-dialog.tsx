...
export function AddTaskDialog({ open, onOpenChange }: AddTaskDialogProps) {
  ...
  const { users, addTask, addNotification } = useAppStore()
  ...
  useEffect(() => {
    ...
    document.addEventListener("app:add-task", handleAddTask)
    return () => {
      document.removeEventListener("app:add-task", handleAddTask)
    }
  }, [onOpenChange])
